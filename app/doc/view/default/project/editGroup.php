...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-10">
                <form class="form-horizontal form" role="form" method="post" action="<?php echo $this->url("doc_controller_project@editGroup",$ginfo['id']); ?>">
                    <legend>编辑组</legend>
                    <div class="form-group">
                        <label class="col-md-2 control-label">名称</label>
                        <div class="col-md-4">
                            <input type="text" name="name"  value="<?php echo $ginfo['name'] ?>" class="form-control" data-rule="名称: required;name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">排序</label>
                        <div class="col-md-2">
                            <input type="text" name="fsort"  value="<?php echo $ginfo['fsort'] ?>" class="form-control" data-rule="排序: required;fsort">
                        </div>
                    </div>
                    <div class="form-group">
