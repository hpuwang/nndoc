...
<div class="row">
    ...
    <div class="col-md-10">
        <div class="center-block">
            <form class="form-horizontal form" method="post" action="<?php echo $this->url("doc_controller_project@add"); ?>" >
                <fieldset>
                    <legend>添加项目</legend>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" placeholder="请输入项目名称" class="form-control" name="name" data-rule="项目名称: required;name">
                        </div>
                    </div>
                    <div class="form-group">
                        <div id="editormd">
<textarea id="page_content" style="display:none;" tabindex="6" name="content">-请输入项目描叙</textarea>
                    </div>
