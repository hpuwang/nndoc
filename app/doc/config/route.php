...
return array(
    ...
    "/groupadd-:number"=>array("doc_controller_project@addGroup","添加组","项目"),
    "/groupedit-:number"=>array("doc_controller_project@editGroup","编辑组","项目"),
    "/group-:number"=>array("doc_controller_project@group","编辑组","项目"),
